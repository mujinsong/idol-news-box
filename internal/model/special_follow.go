...
type SpecialFollow struct {
	gorm.Model
	OwnerID  string    `gorm:"size:50;not null;uniqueIndex:idx_owner_user" json:"owner_id"` // Cookie 所有者的用户ID
	UserID   string    `gorm:"size:50;not null;uniqueIndex:idx_owner_user" json:"user_id"`  // 被关注的微博用户ID
